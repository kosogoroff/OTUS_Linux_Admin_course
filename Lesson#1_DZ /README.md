...
Все претензии в данном случае к разработчикам инсталляционного образа Linux Ubuntu 24.04 LTS и Mainline Linux kernels, которые вносят новые
ошибки в новые релизы, и затем эти новые ошибки существуют в этих релизах в течение длительного времени и не устраняются.
