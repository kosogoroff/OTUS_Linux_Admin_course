...
Результирующий кастомный образ помещённый на Dockerhub, в котором:

- Удалён дефолтный конфиг, отдающий 404.
  
- Добавлен блок `server` с явным указанием корневой директории.
  
- В HTML добавлен `<meta charset="utf-8">`, в конфиге Nginx — `charset utf-8;`.
  
- Образ версионирован для воспроизводимости.
